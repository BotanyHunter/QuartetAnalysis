...
errorList = ["no error",
             ...
             "mrBayes.py: Could not interpret translate file",
             ...
             "post_organize: Could not update QuartetAnalysis metafile",
             "post_organize: Could not interpret QuartetAnalysis metafile",
             "post_organize: missing output suffix",
             ...
             "report_results: Could not open QuartetAnalysis metafile",
             "report_results: Could not create new statistics line",
             "report_results: Could not interpret QuartetAnalysis metafile",
             "report_results: Could not delete stats file",
             "report_results: missing output suffix",
             "delete_mb_output: missing node return status",
             "delete_mb_output: missing job name",
             "delete_mb_output: error finding quartet index",
             "delete_mb_output: Could not open QuartetAnalysis metafile",
             "delete_mb_output: Could not interpret QuartetAnalysis metafile",
             "delete_mb_output: Could not delete bucky results file",
             "delete_mb_output: missing output suffix",
             ...
             "run_bucky.py: Could not open/interpret translate file",
             ...
             "run_bucky.py: could not open/interpret QuartetAnalysis metafile",
